        ...
        <div className="col-md-4">
          ...
          <Form onSubmit={onSubmit} className="mt-4">
            ...
            <Form.Group className="mb-3" controlId="formBasicStarring">
              ...
              <Form.Control  type="text" placeholder="Enter Starring" value={starring} onChange={(e) => setStarring(e.target.value)} />
            </Form.Group>

            <div className="float-right">
              <Button variant="primary" type="submit" onClick={onSubmit} className="mx-2">Save </Button>
              <Button variant="primary"   type="button" onClick={() => onUpdate(movieId)} className="mx-2">  Update </Button>
            </div>
              ...
              {movies.map((movie, index) => {
                return (
                  <tr key="">
                    ...
                    <td> <i onClick={() => selectMovie(movie.id)} >edit</i> <i onClick={() => onDelete(movie.id)}>delete</i> </td>
                  </tr>
                );
              })}
            </tbody>
